                ...
                @foreach ($product as $item)
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img src="{{ $item->product_galleries()->exists() ? url('storage/product/gallery/', $item->product_galleries->first()->image) : asset('frontend/images/content/image-arrived-3.png')}}" alt="{{ $item->name }}"
...
{{-- data:image/png;base64,iVBORw0KGg0AAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mN88B8AAsUB4ZtvXtIAAAAASUVORK5CYII= --}}