...
@section('content')
    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('detail.category', $thisCategory->slug) }}" aria-label="current-page">{{ $thisCategory->name }}</a>
                </li>
            </ul>
        </div>
    </section>
    ...
    <section class="bg-gray-100 px-4 py-16">
        <div class="container mx-auto">
            ...
            <div class="flex overflow-x-auto mb-4 -mx-3" style="flex-wrap: wrap">
